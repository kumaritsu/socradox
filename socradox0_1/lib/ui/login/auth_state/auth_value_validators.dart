...
Either<AuthValueFailures<String>,String> validateUserName({
  required String? userName,
}) {
  final hasMaxLength = userName!.length <= 16;
  if (!hasMaxLength){
    return left(AuthValueFailures.longUserName(failedValue: userName)
    );
  } else {
