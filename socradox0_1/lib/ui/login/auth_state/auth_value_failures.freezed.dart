...
class _$AuthValueFailuresTearOff {
  ...
  LongUserName<T> longUserName<T>({required String? failedValue}) {
...
mixin _$AuthValueFailures<T> {
  ...
  TResult map<TResult extends Object?>({
    ...
    required TResult Function(LongUserName<T> value) longUserName,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? mapOrNull<TResult extends Object?>({
    ...
    TResult Function(LongUserName<T> value)? longUserName,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$LongUserName<T> implements LongUserName<T> {
  const _$LongUserName({required this.failedValue});
  ...
  @override
  String toString() {
    return 'AuthValueFailures<$T>.longUserName(failedValue: $failedValue)';
  }
...
abstract class LongUserName<T> implements AuthValueFailures<T> {
  const factory LongUserName({required String? failedValue}) =
      _$LongUserName<T>;
